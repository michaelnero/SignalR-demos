...
namespace StockTrader.Windows.Common {
    public class TypedTemplateSelector : DataTemplateSelector {
        private readonly Dictionary<string, DataTemplate> cachedDataTemplates = new Dictionary<string, DataTemplate>();
        ...
        private DataTemplate GetCachedDataTemplate(string key) {
            ...
            if (this.cachedDataTemplates.ContainsKey(key)) {
                return this.cachedDataTemplates[key];
            }
        ...
        private static DataTemplate FindTemplate(object source, string key) {
            var frameworkElement = (FrameworkElement)source;
            object obj;
            
            ResourceDictionary resourceDictionary = frameworkElement.Resources;
